...
$wp_customize->add_section('lower_multibar_list_styling', array('title' => 'List Styling','panel' => 'multibar','priority' => 30,));

		//Lower Multibar Widget List Icon Title
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_icon_title',
		    array(
		        'default' => '',
		    )
		);
		$wp_customize->add_control( new WP_Customize_Title_Area( 
			...
			array(
				'label'	=> __( 'Icon' ),
				'section' => 'lower_multibar_list_styling',
				'settings' => 'lower_multibar_widgets_content_lists_icon_title',
			) 
		));

		//Lower Multibar Widget List Icon Type
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_icon',
		    array(
		        'default' => 'none',
		    )
		);
		...
		//Lower Multibar Widget List Padding Title
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_padding_title',
		    array(
		        'default' => '',
		    )
		);
		$wp_customize->add_control( new WP_Customize_Title_Area( 
			...
			array(
				'label'	=> __( 'Spacing' ),
				'section' => 'lower_multibar_list_styling',
				'settings' => 'lower_multibar_widgets_content_lists_padding_title',
			) 
		));
		
		//Lower Multibar Widget List Padding Top
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_padding_top',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_padding_top', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Top Spacing',
		...
		//Lower Multibar Widget List Padding Bottom
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_padding_bottom',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_padding_bottom', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
		...
		//Lower Multibar Widget List Padding Left
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_padding_left',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_padding_left', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Left Spacing',
		...
		//Lower Multibar Widget List Padding Right
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_padding_right',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_padding_right', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Right Spacing',
		...
		//Lower Multibar Widget List Border Title
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_title',
		    array(
		        'default' => '',
		    )
		);
		$wp_customize->add_control( new WP_Customize_Title_Area( 
			...
			array(
				'label'	=> __( 'Borders' ),
				'section' => 'lower_multibar_list_styling',
				'settings' => 'lower_multibar_widgets_content_lists_border_title',
			) 
		));
		
		//Lower Multibar Widget List Border Color
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_color',
		    array(
		        'default' => '#CCC',
		    )
		);
		$wp_customize->add_control(
		    new WP_Customize_Color_Control(
		        ...
		        array(
		            'label' => 'Border Color',
		            'section' => 'lower_multibar_list_styling',
		            'settings' => 'lower_multibar_widgets_content_lists_border_color',
		        )
		    )
		);
		
		//Lower Multibar Widget List Border Style
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_style',
		    array(
		        'default' => 'solid',
		    )
		);
		...
		//Lower Multibar Widget List Border Top
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_top',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_border_top', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Top Border',
		...
		//Lower Multibar Widget List Border Bottom
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_bottom',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_border_bottom', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Bottom Border',
		...
		//Lower Multibar Widget List Border Left
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_left',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_border_left', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Left Border',
		...
		//Lower Multibar Widget List Border Right
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_right',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_border_right', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Right Border',
		...
		//Lower Multibar Widget List Border Radius
		$wp_customize->add_setting(
		    'lower_multibar_widgets_content_lists_border_radius',
		    array(
		        'default' => '0',
		    )
		);
		$wp_customize->add_control( 'lower_multibar_widgets_content_lists_border_radius', array(
			'type'        => 'range',
			'priority'    => 10,
			'section'     => 'lower_multibar_list_styling',
			'label'       => 'Rounded Border',

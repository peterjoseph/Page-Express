...
$wp_customize->add_panel('header_two', array('title' => __( 'Secondary Header' ), 'priority' => 30,) );
        ...
        $wp_customize->add_section('secondary_header_type', array('title' => 'Header Type','panel' => 'header_two','priority' => 30,));
        ...
        $wp_customize->add_control(
            new WP_header_type(
                ...
                'secondary_header_type_select',
                array(
                    'settings'		=> 'secondary_header_type_select',
                    'section'		=> 'secondary_header_type',
        ...
        $wp_customize->add_section('secondary_header_layout', array('title' => 'Layout','panel' => 'header_two','priority' => 30,));
        ...
        $wp_customize->add_control(
            ...
            array(
                ...
                'section' => 'secondary_header_layout',
                'choices' => array(
                    'fixed' => 'Fixed',
                    'fluid' => 'Fluid',
                ),
        ...
        $wp_customize->add_control( 'secondary_header_width_fixed', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_layout',
            'label'       => 'Width [Fixed]',
        ...
        $wp_customize->add_control( 'secondary_header_width_fluid', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_layout',
            'label'       => 'Width [Fluid]',
        ...
        $wp_customize->add_control( 'secondary_header_content_width_fixed', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_layout',
            'label'       => 'Width [Fixed]',
        ...
        $wp_customize->add_control( 'secondary_header_content_width_fluid', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_layout',
            'label'       => 'Width [Fluid]',
        ...
        $wp_customize->add_control( 'secondary_header_border_top', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_borders',
            'label'       => 'Top Border',
        ...
        $wp_customize->add_control( 'secondary_header_border_bottom', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_borders',
            'label'       => 'Bottom Border',
        ...
        $wp_customize->add_control( 'secondary_header_border_left', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_borders',
            'label'       => 'Left Border',
        ...
        $wp_customize->add_control( 'secondary_header_border_right', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_borders',
            'label'       => 'Right Border',
        ...
        $wp_customize->add_control( 'secondary_header_border_radius', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_borders',
        ...
        $wp_customize->add_control( 'secondary_header_padding_top', array(
            'type'        => 'range',
            'priority'    => 10,
        ...
        $wp_customize->add_control( 'secondary_header_padding_bottom', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_padding',
            'label'       => 'Bottom',
        ...
        $wp_customize->add_control( 'secondary_header_padding_left', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_padding',
            'label'       => 'Left',
        ...
        $wp_customize->add_control( 'secondary_header_padding_right', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_padding',
            'label'       => 'Right',
        ...
        $wp_customize->add_control( 'secondary_header_margin_top', array(
            'type'        => 'range',
            'priority'    => 10,
        ...
        $wp_customize->add_control( 'secondary_header_margin_bottom', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_margins',
            'label'       => 'Bottom',
        ...
        //Secondary Header Logo Alignment Title
        $wp_customize->add_setting(
            'secondary_header_logo_alignment_title',
            array(
                'default' => '',
            )
        );
        $wp_customize->add_control( new WP_Customize_Title_Area(
            ...
            array(
                ...
                'section' => 'secondary_header_logo',
                'settings' => 'secondary_header_logo_alignment_title',
            )
        ));
        ...
        $wp_customize->add_control( 'secondary_header_logo_title_font_size', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_logo',
            'label'       => 'Font Size',
        ...
        $wp_customize->add_control( 'secondary_header_logo_tagline_font_size', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_logo',
            'label'       => 'Font Size',
        ...
        //Secondary Header Menu Alignment Title
        $wp_customize->add_setting(
            'secondary_header_menu_alignment_title',
            array(
                'default' => '',
            )
        );
        $wp_customize->add_control( new WP_Customize_Title_Area(
            ...
            array(
                ...
                'settings' => 'secondary_header_menu_alignment_title',
            )
        ));
        ...
        $wp_customize->add_control( 'secondary_header_menu_height', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Height',
        ...
        $wp_customize->add_control( 'secondary_header_menu_spacing', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
        ...
        $wp_customize->add_control( 'secondary_header_menu_font_size', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Font Size',
        ...
        $wp_customize->add_control( 'secondary_header_menu_border_top', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Top Border',
        ...
        $wp_customize->add_control( 'secondary_header_menu_border_bottom', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Bottom Border',
        ...
        $wp_customize->add_control( 'secondary_header_menu_border_left', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Left Border',
        ...
        $wp_customize->add_control( 'secondary_header_menu_border_right', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Right Border',
        ...
        $wp_customize->add_control( 'secondary_header_menu_border_radius', array(
            'type'        => 'range',
            'priority'    => 10,
            'section'     => 'secondary_header_menu_styling',
            'label'       => 'Rounded Border',

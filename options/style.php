...
h4{
    ...
    padding-top:<?php echo get_theme_mod('cw_single_typography_h4_font_padding','0')?>px;
    padding-bottom:<?php echo get_theme_mod('cw_single_typography_h4_font_padding','0')?>px;
}
...
h5{
    ...
    padding-top:<?php echo get_theme_mod('cw_single_typography_h5_font_padding','0')?>px;
    padding-bottom:<?php echo get_theme_mod('cw_single_typography_h5_font_padding','0')?>px;
}
...
#primary_header {
  ...
  <?php if(!get_theme_mod('primary_header_background_visible')) { ?>
  background-color:<?php echo get_theme_mod('primary_header_background_color','#FFF') ?>;
  <?php if(get_theme_mod('primary_header_background_image')) { ?>
  background-image:url('<?php echo get_theme_mod('primary_header_background_image') ?>');
  background-position:<?php echo get_theme_mod('primary_header_background_image_position','left top') ?>;
  background-repeat:<?php echo get_theme_mod('primary_header_background_image_repeat','repeat') ?>;
  ...
  <?php if(get_theme_mod('primary_header_border_style','none') != 'none') { ?>
  border-style:<?php echo get_theme_mod('primary_header_border_style','none') ?>;
  border-color:<?php echo get_theme_mod('primary_header_border_color','#444') ?>;
  ...
  padding-top:<?php echo get_theme_mod('primary_header_padding_top','16') ?>px;
  padding-bottom:<?php echo get_theme_mod('primary_header_padding_bottom','16') ?>px;
...
#primary_header_content #logo {
    <?php if (get_theme_mod('primary_header_type_select','Logo & Menu') == 'Logo & Menu') { ?>
    text-align: left;
    <?php } else { ?>
    text-align:<?php echo get_theme_mod('primary_header_logo_alignment','left') ?>;
    <?php } ?>
    line-height:<?php echo get_theme_mod('primary_header_logo_title_font_size','36') + 2 ?>px;
...
#primary_header_content #logo .title {
    color:<?php echo get_theme_mod('primary_header_logo_title_text_color','#333') ?>;
    font-family:<?php echo get_theme_mod('primary_header_logo_title_fonts','"Helvetica Neue",Helvetica,Arial,sans-serif') ?>;
    ...
    text-transform:<?php echo get_theme_mod('primary_header_logo_title_font_transformation','capitalize') ?>;
}

#primary_header_content #logo .tagline {
    color:<?php echo get_theme_mod('primary_header_logo_tagline_text_color','#333') ?>;
    font-family:<?php echo get_theme_mod('primary_header_logo_tagline_fonts','"Helvetica Neue",Helvetica,Arial,sans-serif') ?>;
    font-size:<?php echo get_theme_mod('primary_header_logo_tagline_font_size','14') ?>px;
    line-height:<?php echo get_theme_mod('primary_header_logo_tagline_font_size','14') + 10 ?>px;
...
<?php } ?>
<?php if(get_theme_mod('primary_header_logo_tagline_position','1')) { ?>
...
#primary_header_content #menu .wrapper {
    <?php if (get_theme_mod('primary_header_type_select','Menu') == 'Menu') { ?>
        display:table;
        <?php if(get_theme_mod('primary_header_menu_alignment','right') == 'center') { ?>
            margin-left:auto;
            margin-right:auto;
        <?php } else if(get_theme_mod('primary_header_menu_alignment','right') == 'left') { ?>
            margin-left:initial;
            margin-right:auto;
        <?php } else { ?>
            margin-right:initial;
        ...
        <?php } else if(get_theme_mod('primary_header_menu_alignment','right') == 'center') { ?>
            left: 50%;
...
#primary_header_content #menu .wrapper .menu-item-description {
    display:block;
...
#primary_header_content #menu li    {
    ...
    <?php } ?>
    border-top:<?php echo get_theme_mod('primary_header_menu_border_top','0') ?>px <?php echo get_theme_mod('primary_header_menu_border_style','none') ?> <?php echo get_theme_mod('primary_header_menu_border_color','#444') ?>;
    border-bottom:<?php echo get_theme_mod('primary_header_menu_border_bottom','0') ?>px <?php echo get_theme_mod('primary_header_menu_border_style','none') ?> <?php echo get_theme_mod('primary_header_menu_border_color','#444') ?>;
    border-left:<?php echo get_theme_mod('primary_header_menu_border_left','0') ?>px <?php echo get_theme_mod('primary_header_menu_border_style','none') ?> <?php echo get_theme_mod('primary_header_menu_border_color','#444') ?>;
    border-right:<?php echo get_theme_mod('primary_header_menu_border_right','0') ?>px <?php echo get_theme_mod('primary_header_menu_border_style','none') ?> <?php echo get_theme_mod('primary_header_menu_border_color','#444') ?>;
    border-radius:<?php echo get_theme_mod('primary_header_menu_border_radius','0') ?>px;
    margin:0px;
    padding-left:<?php echo get_theme_mod('primary_header_menu_spacing','20') ?>px;
    padding-right:<?php echo get_theme_mod('primary_header_menu_spacing','20') ?>px;
    padding:0px;
}
...
#primary_header_content #menu li a  {
    color:<?php echo get_theme_mod('primary_header_menu_link_color','#333') ?>;
    font-family:<?php echo get_theme_mod('primary_header_menu_fonts','"Helvetica Neue",Helvetica,Arial,sans-serif') ?>;
    font-weight:<?php echo get_theme_mod('primary_header_menu_font_weight','normal') ?>;
    font-size:<?php echo get_theme_mod('primary_header_menu_font_size','14') ?>px;
    line-height:<?php echo (get_theme_mod('primary_header_menu_font_size','14') + 4) ?>px;
    padding-left:<?php echo get_theme_mod('primary_header_menu_spacing','20') ?>px;
    padding-right:<?php echo get_theme_mod('primary_header_menu_spacing','20') ?>px;
    padding-top:<?php echo get_theme_mod('primary_header_menu_height','14') ?>px;
    padding-bottom:<?php echo get_theme_mod('primary_header_menu_height','14') ?>px;
    text-align:<?php echo get_theme_mod('primary_header_menu_link_alignment','left') ?>;
    display: inline-block;
    text-decoration:<?php echo get_theme_mod('primary_header_menu_link_decoration','none') ?>;
    text-transform:<?php echo get_theme_mod('primary_header_menu_font_transformation','capitalize') ?>;
}
...
#primary_header_content #menu .current-menu-item a, #primary_header_content #menu .current_page_item a, #primary_header_content #menu a:hover {
    ...
    <?php if(!get_theme_mod('primary_header_menu_background_visible')) { ?>
        background-color:<?php echo get_theme_mod('primary_header_menu_hover_background_color','#F4F4F4') ?>;
...
#secondary_header {
    ...
    <? }  else { ?>
        width:<?php echo get_theme_mod('secondary_header_width_fluid','100') ?>%;
    <?php } ?>
    <?php
    $h1position = get_theme_mod('secondary_header_alignment','center');
    if($h1position == 'center') { ?>
        margin-left:auto;
        margin-right:auto;
    <?php } else if($h1position == 'left') { ?>
    ...
    <?php } ?>
    box-sizing:border-box;
    <?php if(!get_theme_mod('secondary_header_background_visible')) { ?>background-color:<?php echo get_theme_mod('secondary_header_background_color','#000') ?>;<?php } else { ?>background-color:transparent;<?php } ?>
    <?php if(!get_theme_mod('secondary_header_background_visible')) { ?>background-image:url('<?php echo get_theme_mod('secondary_header_background_image','none') ?>');<?php } ?>
    background-position:<?php echo get_theme_mod('secondary_header_background_image_position','initial') ?>;
    background-repeat:<?php echo get_theme_mod('secondary_header_background_image_repeat','no-repeat') ?>;
    background-size:<?php echo get_theme_mod('secondary_header_background_image_type','intial') ?>;
    border-top:<?php echo get_theme_mod('secondary_header_border_top','0') ?>px <?php echo get_theme_mod('secondary_header_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_border_color','#000') ?>;
    border-bottom:<?php echo get_theme_mod('secondary_header_border_bottom','0') ?>px <?php echo get_theme_mod('secondary_header_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_border_color','#000') ?>;
    border-left:<?php echo get_theme_mod('secondary_header_border_left','0') ?>px <?php echo get_theme_mod('secondary_header_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_border_color','#000') ?>;
    border-right:<?php echo get_theme_mod('secondary_header_border_right','0') ?>px <?php echo get_theme_mod('secondary_header_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_border_color','#000') ?>;
    border-radius:<?php echo get_theme_mod('secondary_header_border_radius','0') ?>px;
    padding-top:<?php echo get_theme_mod('secondary_header_padding_top','0') ?>px;
    padding-bottom:<?php echo get_theme_mod('secondary_header_padding_bottom','0') ?>px;
    padding-left:<?php echo get_theme_mod('secondary_header_padding_left','0') ?>px;
    padding-right:<?php echo get_theme_mod('secondary_header_padding_right','0') ?>px;
    margin-top:<?php echo get_theme_mod('secondary_header_margin_top','0') ?>px;
    margin-bottom:<?php echo get_theme_mod('secondary_header_margin_bottom','0') ?>px;
}

#secondary_header_content {
    <?php if(get_theme_mod('secondary_header_content_width_option','fluid') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('secondary_header_content_width_fixed','1000')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('secondary_header_content_width_fluid','100') ?>%;
    <?php } ?>
    <?php if(get_theme_mod('secondary_header_width_option','fluid') == 'fixed') { ?>
        max-width:<?php echo (get_theme_mod('secondary_header_width_fixed','1100')) ?>px;
    <? }  else { ?>
        max-width:<?php echo get_theme_mod('secondary_header_width_fluid','100') ?>%;
    <?php } ?>
    height:auto;
    <?php
    $h1position = get_theme_mod('secondary_header_content_alignment','center');
    if($h1position == 'center') { ?>
        margin-left:auto;
        margin-right:auto;
    <?php } else if($h1position == 'left') { ?>
...
#secondary_header_content #logo {
    text-align:<?php echo get_theme_mod('secondary_header_logo_alignment','left') ?>;
    line-height:<?php echo get_theme_mod('secondary_header_logo_title_font_size','32') + 2 ?>px;
    <?php if (get_theme_mod('secondary_header_type_select','Menu') != 'Logo') { ?>
        flex-shrink: 1
    <?php } else { ?>
        flex-grow: 1;
    <?php } ?>
...
#secondary_header_content #logo a {
    text-decoration:none;
}

#secondary_header_content #logo .wrapper {
    display:inline-block;
    vertical-align:middle;
}

#secondary_header_content #logo .title {
    color:<?php echo get_theme_mod('secondary_header_logo_title_text_color','#FFF') ?>;
    font-family:<?php echo get_theme_mod('secondary_header_logo_title_fonts','Arial,"Helvetica Neue",Helvetica,sans-serif') ?>;
    font-size:<?php echo get_theme_mod('secondary_header_logo_title_font_size','32') ?>px;
    line-height:<?php echo get_theme_mod('secondary_header_logo_title_font_size','32') + 10 ?>px;
    font-weight:<?php echo get_theme_mod('secondary_header_logo_title_font_weight','bold') ?>;
    text-transform:<?php echo get_theme_mod('secondary_header_logo_title_font_transformation','none') ?>;
}

#secondary_header_content #logo .tagline {
    color:<?php echo get_theme_mod('secondary_header_logo_tagline_text_color','#CCC') ?>;
    font-family:<?php echo get_theme_mod('secondary_header_logo_tagline_fonts','Arial,"Helvetica Neue",Helvetica,sans-serif') ?>;
    font-size:<?php echo get_theme_mod('secondary_header_logo_tagline_font_size','18') ?>px;
    line-height:<?php echo get_theme_mod('secondary_header_logo_tagline_font_size','18') + 10 ?>px;
    font-weight:<?php echo get_theme_mod('secondary_header_logo_tagline_font_weight','normal') ?>;
    text-transform:<?php echo get_theme_mod('secondary_header_logo_tagline_font_transformation','none') ?>;
}

<?php if(get_theme_mod('secondary_header_logo_tagline_position')) { ?>
    #secondary_header_content #logo .title, #secondary_header_content #logo .tagline {
    display:inline;
    }
<? } ?>
...
#secondary_header_content #menu .wrapper {
    <?php if (get_theme_mod('secondary_header_type_select','Menu') == 'Menu') { ?>
        display:table;
        <?php if(get_theme_mod('secondary_header_menu_alignment','right') == 'center') { ?>
            margin-left:auto;
            margin-right:auto;
        <?php } else if(get_theme_mod('secondary_header_menu_alignment','right') == 'left') { ?>
            margin-left:initial;
            margin-right:auto;
        <?php } else { ?>
            margin-right:initial;
        ...
        display:table;
        top:50%;
        <?php if(get_theme_mod('secondary_header_menu_alignment','right') == 'right') { ?>
            right:0;
            transform: translate(0,-50%);
        <?php } else if(get_theme_mod('secondary_header_menu_alignment','right') == 'center') { ?>
            left: 50%;
            transform: translate(-50%,-50%);
        <?php } else { ?>
            left:0;
...
#secondary_header_content #menu .wrapper .menu-item-description {
    display:block;
    font-size:<?php echo (get_theme_mod('secondary_header_menu_font_size','14') - 4) ?>px;
    text-decoration: none;
    font-weight:300;
    text-transform: none;
}

#secondary_header_content #menu .wrapper li a span.menu-item-description {
    text-decoration: none;
}

#secondary_header_content #menu ul    {
    margin: 0; padding: 0;
}

#secondary_header_content #menu li    {
    position: relative;
    text-align:center;
    display:inline-block;
    <?php if(!get_theme_mod('secondary_header_menu_background_visible')) { ?>
        ...
        background-image:url('<?php echo get_theme_mod('secondary_header_menu_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('secondary_header_menu_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('secondary_header_menu_background_image_repeat','no-repeat') ?>;
    <?php } ?>
    border-top:<?php echo get_theme_mod('secondary_header_menu_border_top','0') ?>px <?php echo get_theme_mod('secondary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_menu_border_color','#000') ?>;
    border-bottom:<?php echo get_theme_mod('secondary_header_menu_border_bottom','0') ?>px <?php echo get_theme_mod('secondary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_menu_border_color','#000') ?>;
    border-left:<?php echo get_theme_mod('secondary_header_menu_border_left','0') ?>px <?php echo get_theme_mod('secondary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_menu_border_color','#000') ?>;
    border-right:<?php echo get_theme_mod('secondary_header_menu_border_right','0') ?>px <?php echo get_theme_mod('secondary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('secondary_header_menu_border_color','#000') ?>;
    border-radius:<?php echo get_theme_mod('secondary_header_menu_border_radius','0') ?>px;
    margin:0px;
    padding-left:<?php echo get_theme_mod('secondary_header_menu_spacing','5') ?>px;
    padding-right:<?php echo get_theme_mod('secondary_header_menu_spacing','5') ?>px;
    padding:0px;
}
...
#secondary_header_content #menu li a  {
    color:<?php echo get_theme_mod('secondary_header_menu_link_color','#FFF') ?>;
    font-family:<?php echo get_theme_mod('secondary_header_menu_fonts','Arial,"Helvetica Neue",Helvetica,sans-serif') ?>;
    font-weight:<?php echo get_theme_mod('secondary_header_menu_font_weight','normal') ?>;
    font-size:<?php echo get_theme_mod('secondary_header_menu_font_size','14') ?>px;
    line-height:<?php echo (get_theme_mod('secondary_header_menu_font_size','14') + 4) ?>px;
    padding-left:<?php echo get_theme_mod('secondary_header_menu_spacing','5') ?>px;
    padding-right:<?php echo get_theme_mod('secondary_header_menu_spacing','5') ?>px;
    ...
    text-align:<?php echo get_theme_mod('secondary_header_menu_link_alignment','center') ?>;
    display: inline-block;
    text-decoration:<?php echo get_theme_mod('secondary_header_menu_link_decoration','none') ?>;
    text-transform:<?php echo get_theme_mod('secondary_header_menu_font_transformation','none') ?>;
}

#secondary_header_content #menu .current-menu-item a, #secondary_header_content #menu .current_page_item a, #secondary_header_content #menu a:hover {
    color:<?php echo get_theme_mod('secondary_header_menu_link_hover_color','#CCC') ?>;
    <?php if(!get_theme_mod('secondary_header_menu_background_visible')) { ?>
        background-color:<?php echo get_theme_mod('secondary_header_menu_hover_background_color','#C7C7C7') ?>;
        background-image:url('<?php echo get_theme_mod('secondary_header_menu_hover_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('secondary_header_menu_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('secondary_header_menu_background_image_repeat','no-repeat') ?>;
    <?php } ?>
}

#secondary_header_content #menu .sub-menu {
    position: absolute;
    display: none;
    top: 100%;
    <?php if(get_theme_mod('secondary_header_menu_alignment','right') == 'right') { ?>
    ...
    <?php } ?>
    <?php if(!get_theme_mod('secondary_header_menu_background_visible')) { ?>
        background-color:<?php echo get_theme_mod('secondary_header_menu_background_color','#C7C7C7') ?>;
    <?php } else { ?>
        background-image:url('<?php echo get_bloginfo('template_url') ?>/images/transparent_background.png');
    <?php } ?>
    z-index:5;
...
#secondary_header_content #menu ul ul {
    text-align: left;
}

#secondary_header_content #menu ul ul li {
    float: none;
    text-align:<?php echo get_theme_mod('secondary_header_menu_link_alignment','center') ?>;
}

#secondary_header_content #menu ul ul li a {
    width:240px;
}

#secondary_header_content #menu ul li:hover > ul {
    display: block;
}

#tertiary_header {
    <?php if(get_theme_mod('tertiary_header_width_option','fluid') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('tertiary_header_width_fixed','1100')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('tertiary_header_width_fluid','100') ?>%;
    <?php } ?>
    <?php
    $h1position = get_theme_mod('tertiary_header_alignment','center');
    if($h1position == 'center') { ?>
        margin-left:auto;
        margin-right:auto;
    <?php } else if($h1position == 'left') { ?>
    ...
    <?php } ?>
    box-sizing:border-box;
    <?php if(!get_theme_mod('tertiary_header_background_visible')) { ?>background-color:<?php echo get_theme_mod('tertiary_header_background_color','#000') ?>;<?php } else { ?>background-color:transparent;<?php } ?>
    <?php if(!get_theme_mod('tertiary_header_background_visible')) { ?>background-image:url('<?php echo get_theme_mod('tertiary_header_background_image','none') ?>');<?php } ?>
    background-position:<?php echo get_theme_mod('tertiary_header_background_image_position','initial') ?>;
    background-repeat:<?php echo get_theme_mod('tertiary_header_background_image_repeat','no-repeat') ?>;
    background-size:<?php echo get_theme_mod('tertiary_header_background_image_type','intial') ?>;
    border-top:<?php echo get_theme_mod('tertiary_header_border_top','0') ?>px <?php echo get_theme_mod('tertiary_header_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_border_color','#000') ?>;
    border-bottom:<?php echo get_theme_mod('tertiary_header_border_bottom','0') ?>px <?php echo get_theme_mod('tertiary_header_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_border_color','#000') ?>;
    border-left:<?php echo get_theme_mod('tertiary_header_border_left','0') ?>px <?php echo get_theme_mod('tertiary_header_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_border_color','#000') ?>;
    border-right:<?php echo get_theme_mod('tertiary_header_border_right','0') ?>px <?php echo get_theme_mod('tertiary_header_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_border_color','#000') ?>;
    border-radius:<?php echo get_theme_mod('tertiary_header_border_radius','0') ?>px;
    padding-top:<?php echo get_theme_mod('tertiary_header_padding_top','0') ?>px;
    padding-bottom:<?php echo get_theme_mod('tertiary_header_padding_bottom','0') ?>px;
    padding-left:<?php echo get_theme_mod('tertiary_header_padding_left','0') ?>px;
    padding-right:<?php echo get_theme_mod('tertiary_header_padding_right','0') ?>px;
    margin-top:<?php echo get_theme_mod('tertiary_header_margin_top','0') ?>px;
    margin-bottom:<?php echo get_theme_mod('tertiary_header_margin_bottom','0') ?>px;
}

#tertiary_header_content {
    <?php if(get_theme_mod('tertiary_header_content_width_option','fluid') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('tertiary_header_content_width_fixed','1000')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('tertiary_header_content_width_fluid','100') ?>%;
    <?php } ?>
    <?php if(get_theme_mod('tertiary_header_width_option','fluid') == 'fixed') { ?>
        max-width:<?php echo (get_theme_mod('tertiary_header_width_fixed','1100')) ?>px;
    <? }  else { ?>
        max-width:<?php echo get_theme_mod('tertiary_header_width_fluid','100') ?>%;
    <?php } ?>
    height:auto;
    <?php
    $h1position = get_theme_mod('tertiary_header_content_alignment','center');
    if($h1position == 'center') { ?>
        margin-left:auto;
        margin-right:auto;
    <?php } else if($h1position == 'left') { ?>
...
#tertiary_header_content #logo {
    text-align:<?php echo get_theme_mod('tertiary_header_logo_alignment','left') ?>;
    line-height:<?php echo get_theme_mod('tertiary_header_logo_title_font_size','32') + 2 ?>px;
    <?php if (get_theme_mod('tertiary_header_type_select','Menu') != 'Logo') { ?>
        flex-shrink: 1
    <?php } else { ?>
        flex-grow: 1;
    <?php } ?>
...
#tertiary_header_content #logo a {
    text-decoration:none;
}

#tertiary_header_content #logo .wrapper {
    display:inline-block;
    vertical-align:middle;
}

#tertiary_header_content #logo .title {
    color:<?php echo get_theme_mod('tertiary_header_logo_title_text_color','#FFF') ?>;
    font-family:<?php echo get_theme_mod('tertiary_header_logo_title_fonts','Arial,"Helvetica Neue",Helvetica,sans-serif') ?>;
    font-size:<?php echo get_theme_mod('tertiary_header_logo_title_font_size','32') ?>px;
    line-height:<?php echo get_theme_mod('tertiary_header_logo_title_font_size','32') + 10 ?>px;
    font-weight:<?php echo get_theme_mod('tertiary_header_logo_title_font_weight','bold') ?>;
    text-transform:<?php echo get_theme_mod('tertiary_header_logo_title_font_transformation','none') ?>;
}

#tertiary_header_content #logo .tagline {
    color:<?php echo get_theme_mod('tertiary_header_logo_tagline_text_color','#CCC') ?>;
    font-family:<?php echo get_theme_mod('tertiary_header_logo_tagline_fonts','Arial,"Helvetica Neue",Helvetica,sans-serif') ?>;
    font-size:<?php echo get_theme_mod('tertiary_header_logo_tagline_font_size','18') ?>px;
    line-height:<?php echo get_theme_mod('tertiary_header_logo_tagline_font_size','18') + 10 ?>px;
    font-weight:<?php echo get_theme_mod('tertiary_header_logo_tagline_font_weight','normal') ?>;
    text-transform:<?php echo get_theme_mod('tertiary_header_logo_tagline_font_transformation','none') ?>;
}

<?php if(get_theme_mod('tertiary_header_logo_tagline_position')) { ?>
    #tertiary_header_content #logo .title, #tertiary_header_content #logo .tagline {
    display:inline;
    }
<? } ?>
...
#tertiary_header_content #menu .wrapper {
    <?php if (get_theme_mod('tertiary_header_type_select','Menu') == 'Menu') { ?>
        display:table;
        <?php if(get_theme_mod('tertiary_header_menu_alignment','right') == 'center') { ?>
            margin-left:auto;
            margin-right:auto;
        <?php } else if(get_theme_mod('tertiary_header_menu_alignment','right') == 'left') { ?>
            margin-left:initial;
            margin-right:auto;
        <?php } else { ?>
            margin-right:initial;
        ...
        display:table;
        top:50%;
        <?php if(get_theme_mod('tertiary_header_menu_alignment','right') == 'right') { ?>
            right:0;
            transform: translate(0,-50%);
        <?php } else if(get_theme_mod('tertiary_header_menu_alignment','right') == 'center') { ?>
            left: 50%;
            transform: translate(-50%,-50%);
        <?php } else { ?>
            left:0;
...
#tertiary_header_content #menu .wrapper .menu-item-description {
    display:block;
    font-size:<?php echo (get_theme_mod('tertiary_header_menu_font_size','14') - 4) ?>px;
    text-decoration: none;
    font-weight:300;
    text-transform: none;
}

#tertiary_header_content #menu .wrapper li a span.menu-item-description {
    text-decoration: none;
}

#tertiary_header_content #menu ul    {
    margin: 0; padding: 0;
}

#tertiary_header_content #menu li    {
    position: relative;
    text-align:center;
    display:inline-block;
    <?php if(!get_theme_mod('tertiary_header_menu_background_visible')) { ?>
        ...
        background-image:url('<?php echo get_theme_mod('tertiary_header_menu_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('tertiary_header_menu_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('tertiary_header_menu_background_image_repeat','no-repeat') ?>;
    <?php } ?>
    border-top:<?php echo get_theme_mod('tertiary_header_menu_border_top','0') ?>px <?php echo get_theme_mod('tertiary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_menu_border_color','#000') ?>;
    border-bottom:<?php echo get_theme_mod('tertiary_header_menu_border_bottom','0') ?>px <?php echo get_theme_mod('tertiary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_menu_border_color','#000') ?>;
    border-left:<?php echo get_theme_mod('tertiary_header_menu_border_left','0') ?>px <?php echo get_theme_mod('tertiary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_menu_border_color','#000') ?>;
    border-right:<?php echo get_theme_mod('tertiary_header_menu_border_right','0') ?>px <?php echo get_theme_mod('tertiary_header_menu_border_style','solid') ?> <?php echo get_theme_mod('tertiary_header_menu_border_color','#000') ?>;
    border-radius:<?php echo get_theme_mod('tertiary_header_menu_border_radius','0') ?>px;
    margin:0px;
    padding-left:<?php echo get_theme_mod('tertiary_header_menu_spacing','5') ?>px;
    padding-right:<?php echo get_theme_mod('tertiary_header_menu_spacing','5') ?>px;
    padding:0px;
}
...
#tertiary_header_content #menu li a  {
    color:<?php echo get_theme_mod('tertiary_header_menu_link_color','#FFF') ?>;
    font-family:<?php echo get_theme_mod('tertiary_header_menu_fonts','Arial,"Helvetica Neue",Helvetica,sans-serif') ?>;
    font-weight:<?php echo get_theme_mod('tertiary_header_menu_font_weight','normal') ?>;
    font-size:<?php echo get_theme_mod('tertiary_header_menu_font_size','14') ?>px;
    line-height:<?php echo (get_theme_mod('tertiary_header_menu_font_size','14') + 4) ?>px;
    padding-left:<?php echo get_theme_mod('tertiary_header_menu_spacing','5') ?>px;
    padding-right:<?php echo get_theme_mod('tertiary_header_menu_spacing','5') ?>px;
    ...
    text-align:<?php echo get_theme_mod('tertiary_header_menu_link_alignment','center') ?>;
    display: inline-block;
    text-decoration:<?php echo get_theme_mod('tertiary_header_menu_link_decoration','none') ?>;
    text-transform:<?php echo get_theme_mod('tertiary_header_menu_font_transformation','none') ?>;
}

#tertiary_header_content #menu .current-menu-item a, #tertiary_header_content #menu .current_page_item a, #tertiary_header_content #menu a:hover {
    color:<?php echo get_theme_mod('tertiary_header_menu_link_hover_color','#CCC') ?>;
    <?php if(!get_theme_mod('tertiary_header_menu_background_visible')) { ?>
        background-color:<?php echo get_theme_mod('tertiary_header_menu_hover_background_color','#C7C7C7') ?>;
        background-image:url('<?php echo get_theme_mod('tertiary_header_menu_hover_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('tertiary_header_menu_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('tertiary_header_menu_background_image_repeat','no-repeat') ?>;
    <?php } ?>
}

#tertiary_header_content #menu .sub-menu {
    position: absolute;
    display: none;
    top: 100%;
    <?php if(get_theme_mod('tertiary_header_menu_alignment','right') == 'right') { ?>
    ...
    <?php } ?>
    <?php if(!get_theme_mod('tertiary_header_menu_background_visible')) { ?>
        background-color:<?php echo get_theme_mod('tertiary_header_menu_background_color','#C7C7C7') ?>;
    <?php } else { ?>
        background-image:url('<?php echo get_bloginfo('template_url') ?>/images/transparent_background.png');
    <?php } ?>
    z-index:5;
...
#tertiary_header_content #menu ul ul {
    text-align: left;
}

#tertiary_header_content #menu ul ul li {
    float: none;
    text-align:<?php echo get_theme_mod('tertiary_header_menu_link_alignment','center') ?>;
}

#tertiary_header_content #menu ul ul li a {
    width:240px;
}

#tertiary_header_content #menu ul li:hover > ul {
    display: block;
}
...
.upper_unibar_widget_content li {
    list-style-type: <?php echo get_theme_mod('upper_unibar_widgets_content_lists_icon','none') ?>;
    border-top:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_top','0') ?>px <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-bottom:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_bottom','0') ?>px <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-left:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_left','0') ?>px <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-right:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_right','0') ?>px <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-radius:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_border_radius','0') ?>px;
    padding-top:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_padding_top','0') ?>px;
    padding-bottom:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_padding_bottom','0') ?>px;
    margin-top:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_padding_top','0') ?>px;
    margin-bottom:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_padding_top','0') ?>px;
    padding-left:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_padding_left','0') ?>px;
    padding-right:<?php echo get_theme_mod('upper_unibar_widgets_content_lists_padding_right','0') ?>px;
...
#upper_unibar_content ul.menu li {
  ...
  #upper_unibar_content ul.menu li:hover {
	<?php if(get_theme_mod('upper_unibar_menu_type') == 'vertical') { ?>
		<?php if(!get_theme_mod('upper_unibar_vertical_menu_background_visible')) { ?>
  ...
  #upper_unibar_content ul.menu li a {
	<?php if(get_theme_mod('upper_unibar_menu_type') == 'vertical') { ?>
...
#upper_unibar_content ul.menu .sub-menu {
    display: none;
}
...
.left_sidebar_widget li {
    list-style-type: <?php echo get_theme_mod('left_sidebar_widgets_content_lists_icon','none') ?>;
    border-top:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_top','0') ?>px <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_color','#CCC') ?>;
    border-bottom:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_bottom','0') ?>px <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_color','#CCC') ?>;
    border-left:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_left','0') ?>px <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_color','#CCC') ?>;
    border-right:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_right','0') ?>px <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_color','#CCC') ?>;
    border-radius:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_border_radius','0') ?>px;
    padding-top:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_padding_top','0') ?>px;
    padding-bottom:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_padding_bottom','0') ?>px;
    margin-top:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_padding_top','0') ?>px;
    margin-bottom:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_padding_top','0') ?>px;
    padding-left:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_padding_left','0') ?>px;
    padding-right:<?php echo get_theme_mod('left_sidebar_widgets_content_lists_padding_right','0') ?>px;
...
.left_sidebar_widget ul.menu .sub-menu {
    display: none;
}
...
.right_sidebar_widget ul.menu ul {
        list-style: none;
        margin: 0px;
        padding:0px;
    }

.right_sidebar_widget ul.menu ol {
    list-style: none;
    margin:0px;
    padding:0px;
}

.right_sidebar_widget ul.menu .sub-menu {
    display: none;
}
...
#single_content {
    overflow: hidden;
    text-overflow: ellipsis;
    padding:<?php echo get_theme_mod('postpage_spacing','10')?>px;
}
...
#comments {
    <?php if(!get_theme_mod('cw_single_comments_backgrounds_comment_area_background_visibility','true')) { ?>
        background-color:<?php echo get_theme_mod('cw_single_comments_backgrounds_comment_area_background_color','#F3F3F3') ?>;
        background-image:url('<?php echo get_theme_mod('cw_single_comments_backgrounds_comment_area_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('cw_single_comments_backgrounds_comment_area_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('cw_single_comments_backgrounds_comment_area_background_image_repeat','repeat') ?>;
        background-size:<?php echo get_theme_mod('cw_single_comments_backgrounds_comment_area_background_image_type','initial') ?>;
    <?php } ?>
    margin:20px auto 20px auto;
    padding-top:<?php echo get_theme_mod('cw_single_comments_padding_comment_area_top','10') ?>px;
    padding-bottom:<?php echo get_theme_mod('cw_single_comments_padding_comment_area_bottom','10') ?>px;
    padding-left:<?php echo get_theme_mod('cw_single_comments_padding_comment_area_left','10') ?>px;
    padding-right:<?php echo get_theme_mod('cw_single_comments_padding_comment_area_right','10') ?>px;
    border-top:<?php echo get_theme_mod('cw_single_comments_border_comment_area_top','0') ?>px <?php echo get_theme_mod('cw_single_comments_border_comment_area_border_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_comment_area_color','#CCC') ?>;
    border-bottom:<?php echo get_theme_mod('cw_single_comments_border_comment_area_bottom','0') ?>px <?php echo get_theme_mod('cw_single_comments_border_comment_area_border_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_comment_area_color','#CCC') ?>;
    border-left:<?php echo get_theme_mod('cw_single_comments_border_comment_area_left','0') ?>px <?php echo get_theme_mod('cw_single_comments_border_comment_area_border_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_comment_area_color','#CCC') ?>;
    border-right:<?php echo get_theme_mod('cw_single_comments_border_comment_area_right','0') ?>px <?php echo get_theme_mod('cw_single_comments_border_comment_area_border_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_comment_area_color','#CCC') ?>;
    border-radius:<?php echo get_theme_mod('cw_single_comments_border_comment_area_radius','0') ?>px;
}
...
#comments .vcard img {
    <?php if(get_theme_mod('cw_single_comments_layout_avatar_visibility','left') == "left") { ?>
        float:left;
...
#comments .comments_list .comment-body {
    <?php if(!get_theme_mod('cw_single_comments_backgrounds_top_level_comment_background_visibility')) { ?>
        background-color:<?php echo get_theme_mod('cw_single_comments_backgrounds_top_level_comment_background_color','#F0F0F0') ?>;
        background-image:url('<?php echo get_theme_mod('cw_single_comments_backgrounds_top_level_comment_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('cw_single_comments_backgrounds_top_level_comments_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('cw_single_comments_backgrounds_top_level_comments_background_image_repeat','repeat') ?>;
        background-size:<?php echo get_theme_mod('cw_single_comments_backgrounds_top_level_comments_background_image_type','initial') ?>;
    <?php } ?>
    margin:15px 0 15px 0;
    padding-top:<?php echo get_theme_mod('cw_single_comments_padding_individual_comment_top','20') ?>px;
    padding-bottom:<?php echo get_theme_mod('cw_single_comments_padding_individual_comment_bottom','20') ?>px;
    padding-left:<?php echo get_theme_mod('cw_single_comments_padding_individual_comment_left','20') ?>px;
    padding-right:<?php echo get_theme_mod('cw_single_comments_padding_individual_comment_right','20') ?>px;

    border-top:<?php echo get_theme_mod('cw_single_comments_border_individual_comment_top','0') ?>px <?php echo get_theme_mod('cw_single_comments_border_individual_comment_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_individual_comment_color','#CCC') ?>;
    border-bottom:<?php echo get_theme_mod('cw_single_comments_border_individual_comment_bottom','1') ?>px <?php echo get_theme_mod('cw_single_comments_border_individual_comment_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_individual_comment_color','#CCC') ?>;
    border-left:<?php echo get_theme_mod('cw_single_comments_border_individual_comment_left','3') ?>px <?php echo get_theme_mod('cw_single_comments_border_individual_comment_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_individual_comment_color','#CCC') ?>;
    border-right:<?php echo get_theme_mod('cw_single_comments_border_individual_comment_right','0') ?>px <?php echo get_theme_mod('cw_single_comments_border_individual_comment_style','solid') ?> <?php echo get_theme_mod('cw_single_comments_border_individual_comment_color','#CCC') ?>;
    border-radius:<?php echo get_theme_mod('cw_single_comments_border_individual_comment_radius','0') ?>px;
}
...
#comments .comments_list .children .comment-body {
    <?php if(!get_theme_mod('cw_single_comments_backgrounds_responding_comments_background_visibility')) { ?>
        background-color:<?php echo get_theme_mod('cw_single_comments_backgrounds_responding_comments_background_color','#F0F0F0') ?>;
        background-image:url('<?php echo get_theme_mod('cw_single_comments_backgrounds_responding_comments_background_image','none') ?>');
        background-position:<?php echo get_theme_mod('cw_single_comments_backgrounds_responding_comments_background_image_position','initial') ?>;
        background-repeat:<?php echo get_theme_mod('cw_single_comments_backgrounds_responding_comments_background_image_repeat','repeat') ?>;
        background-size:<?php echo get_theme_mod('cw_single_comments_backgrounds_responding_comments_background_image_type','initial') ?>;
    <?php } ?>
}
...
.lower_unibar_widget_content li {
    list-style-type: <?php echo get_theme_mod('lower_unibar_widgets_content_lists_icon','none') ?>;
    border-top:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_top','0') ?>px <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-bottom:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_bottom','0') ?>px <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-left:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_left','0') ?>px <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-right:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_right','0') ?>px <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_color','#CCC') ?>;
    border-radius:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_border_radius','0') ?>px;
    padding-top:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_padding_top','0') ?>px;
    padding-bottom:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_padding_bottom','0') ?>px;
    margin-top:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_padding_top','0') ?>px;
    margin-bottom:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_padding_top','0') ?>px;
    padding-left:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_padding_left','0') ?>px;
    padding-right:<?php echo get_theme_mod('lower_unibar_widgets_content_lists_padding_right','0') ?>px;
...
#lower_unibar_content ul.menu li {
  ...
  #lower_unibar_content ul.menu li:hover {
	<?php if(get_theme_mod('lower_unibar_menu_type') == 'vertical') { ?>
		<?php if(!get_theme_mod('lower_unibar_vertical_menu_background_visible')) { ?>
  ...
  #lower_unibar_content ul.menu li a {
	<?php if(get_theme_mod('lower_unibar_menu_type') == 'vertical') { ?>
  ...
  #lower_unibar_content ul.menu li a:hover {
	<?php if(get_theme_mod('lower_unibar_menu_type') == 'vertical') { ?>
...
#lower_multibar {
    ...
    <?php if(get_theme_mod('lower_multibar_width_option','fluid') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('lower_multibar_width_fixed','1100')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('lower_multibar_width_fluid','100') ?>%;
    <?php } ?>
    <?php
...
#lower_multibar_content {
    <?php if(get_theme_mod('lower_multibar_content_width_option','fixed') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('lower_multibar_content_width_fixed','1100')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('lower_multibar_content_width_fluid','100') ?>%;
    <?php } ?>
    <?php if(get_theme_mod('lower_multibar_width_option','fluid') == 'fixed') { ?>
        max-width:<?php echo (get_theme_mod('lower_multibar_width_fixed','1100')) ?>px;
    <? }  else { ?>
        max-width:<?php echo get_theme_mod('lower_multibar_width_fluid','100') ?>%;
    <?php } ?>
    height:auto;
    <?php
...
#lower_multibar_widget {
      padding:<?php echo get_theme_mod('lower_multibar_panel_padding','10') ?>px;
}

#lower_multibar_widget ul.menu {
	display:block;
    list-style: none;
    margin: 0px;
}

#lower_multibar_widget ul.menu li {
    display:block;
...
#lower_multibar_widget ul.menu li:hover {
  <?php if(!get_theme_mod('lower_multibar_menu_background_visible')) { ?>
...
#lower_multibar_widget ul.menu li a {
    display:block;
...
#lower_multibar_widget ul.menu li a:hover{
    display:block;
    color:<?php echo get_theme_mod('lower_multibar_menu_link_hover_color','#333') ?>;
}

#lower_multibar_widget ul.menu .sub-menu {
display: none;
}

.lower_multibar_widget_header {
...
.lower_multibar_widget_content a {
...
.lower_multibar_widget_content li {
    list-style-type: <?php echo get_theme_mod('lower_multibar_widgets_content_lists_icon','none') ?>;
    border-top:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_top','0') ?>px <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_color','#CCC') ?>;
    border-bottom:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_bottom','0') ?>px <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_color','#CCC') ?>;
    border-left:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_left','0') ?>px <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_color','#CCC') ?>;
    border-right:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_right','0') ?>px <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_style','solid') ?> <?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_color','#CCC') ?>;
    border-radius:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_border_radius','0') ?>px;
    padding-top:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_padding_top','0') ?>px;
    padding-bottom:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_padding_bottom','0') ?>px;
    margin-top:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_padding_top','0') ?>px;
    margin-bottom:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_padding_top','0') ?>px;
    padding-left:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_padding_left','0') ?>px;
    padding-right:<?php echo get_theme_mod('lower_multibar_widgets_content_lists_padding_right','0') ?>px;
...
#footer {
    <?php if(get_theme_mod('footer_background_width_option','fluid') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('footer_background_width_fixed','1100')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('footer_background_width_fluid','100') ?>%;
    <?php } ?>
  ...
  #footer_content {
    <?php if(get_theme_mod('footer_content_area_width_option','fixed') == 'fixed') { ?>
        width:<?php echo (get_theme_mod('footer_content_area_width_fixed','1000')) ?>px;
    <? }  else { ?>
        width:<?php echo get_theme_mod('footer_content_area_width_fluid','100') ?>%;
    <?php } ?>
    <?php if(get_theme_mod('footer_background_width_option','fluid') == 'fixed') { ?>
        max-width:<?php echo (get_theme_mod('footer_background_width_fixed','1100')) ?>px;
    <? }  else { ?>
        max-width:<?php echo get_theme_mod('footer_background_width_fluid','100') ?>%;
    <?php } ?>
  ...
  #footer #footer_content .footer_widgets #sidebar ul.menu li a:hover {
    ...
    #footer #footer_content .footer_widgets #sidebar ul.menu .sub-menu {
        display: none;
    }
